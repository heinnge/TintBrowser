...
import com.myopenware.addons.AddonMenuItem;
import com.myopenware.controllers.Controller;
import com.myopenware.model.DownloadItem;
import com.myopenware.ui.activities.TintBrowserActivity;
import com.myopenware.ui.fragments.BaseWebViewFragment;
import com.myopenware.ui.managers.UIManager;
import com.myopenware.utils.ApplicationUtils;
import com.myopenware.utils.Constants;
import com.myopenware.utils.UrlUtils;
...
public class CustomWebView extends WebView implements DownloadListener {
	...
	private Timer injectJSTimer = null;
	...
	public void onReceivedTitle(String title) {
		injectJSTimer = new Timer();
		injectJSTimer.scheduleAtFixedRate(new TimerTask() {
	...
	public void injectJS() {
		if (android.os.Build.VERSION.SDK_INT == 17) {
			this.loadRawUrl("javascript:" + ApplicationUtils.getStringFromRawResource(mContext, R.raw.injectcss_js_svg));
		} else {
			this.loadRawUrl("javascript:" + ApplicationUtils.getStringFromRawResource(mContext, R.raw.injectcss_js_ttf));
		}
		this.loadRawUrl("javascript:" + ApplicationUtils.getStringFromRawResource(mContext, R.raw.fonttagger_js));
	}
