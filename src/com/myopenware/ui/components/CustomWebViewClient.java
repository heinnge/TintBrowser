...
package com.myopenware.ui.components;
...
import com.myopenware.R;

import com.myopenware.providers.SslExceptionsWrapper;
import com.myopenware.ui.managers.UIManager;
import com.myopenware.utils.ApplicationUtils;
...
public class CustomWebViewClient extends WebViewClient {
	...
	public WebResourceResponse shouldInterceptRequest(WebView view, final String url) {
		Log.i("Barebones", "ShouldInterceptRequest: " + url);
		if (url.endsWith("com.myopenware.zawgyi.svg")) {
			return ApplicationUtils.getWebResourceResponseFromRawResource(view.getContext(), R.raw.zawgyi_svg, "image/svg+xml", "utf-8");
		} else if (url.endsWith("com.myopenware.zawgyi.ttf")) {
			return ApplicationUtils.getWebResourceResponseFromRawResource(view.getContext(), R.raw.zawgyi_ttf, "application/x-font-truetype", "utf-8");
		} else if (url.endsWith("com.myopenware.padauk.svg")) {
			return ApplicationUtils.getWebResourceResponseFromRawResource(view.getContext(), R.raw.padauk_svg, "image/svg+xml", "utf-8");
		} else if (url.endsWith("com.myopenware.padauk.ttf")) {
			return ApplicationUtils.getWebResourceResponseFromRawResource(view.getContext(), R.raw.padauk_ttf, "application/x-font-truetype", "utf-8");
		}
