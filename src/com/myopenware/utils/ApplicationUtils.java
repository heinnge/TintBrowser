...
public class ApplicationUtils {
	 ...
	 * @return The loaded string.
	 */
	public static WebResourceResponse getWebResourceResponseFromRawResource(Context context, int resourceId, String mime, String encoding) {
